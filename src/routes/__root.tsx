  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-parchment-gradient px-4">
      <div className="max-w-md text-center">
        <p className="font-devanagari text-sm uppercase tracking-[0.3em] text-accent">
          पृष्ठ नहीं मिला
        </p>
        <h1 className="mt-4 font-heading text-7xl font-semibold text-primary">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-heritage transition-colors hover:bg-maroon-deep"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Vanshavali" },
      { name: "format-detection", content: "telephone=no" },

      { title: "Vanshavali — Preserve Your Family Lineage Across Generations" },
      {
        name: "description",
        content:
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@500;600;700&family=Inter:wght@400;500;600&family=Tiro+Devanagari+Hindi:ital@0;1&display=swap",
      },
    ],
  }),
